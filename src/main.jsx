...
function App() {
  ...
  return <DayPage day={day} answers={answers} setAnswers={setAnswers} back={() => setScreen("dashboard")} openDay={openDay} videoId={videoId} edit={() => setEditor(true)} editor={editor} close={() => setEditor(false)} videoValue={videoValue} setVideoValue={setVideoValue} saveVideo={saveVideo} />;
}
